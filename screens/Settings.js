    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <Text style={styles.text}>App-Settings & More</Text>
        </View>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.T}>App-Version: 2.0</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.T}>Software: C-OS2</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.T}>App Chat-Bot</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.ver1}
          onPress={() => {
          ...
          <Text style={styles.T}>Space-Vortex</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.T}>App-Feedback</Text>
        </TouchableOpacity>
